...
if ($_SESSION["usertype"] != 2) {
    ...
    echo "<div class='col-sm-4'>
			<div class = 'profile-page-oxygen-status'>
				<div class='col-sm-12 oxygen'>
					<h2 class='text-centered oxygen-level-raised'>Oxygen Level</h2><br><br>
					<button class='btn' style = 'color: white; background-color:crimson; margin-left: 38%' id='updateOxygenBtn' >Save Oxygen</button><br><br>
				</div>
    ...
    foreach ($oxygenData as $currLevel) {
        if ($currLevel->start_date == null) {
            echo "<div><img src='../images/up.png' class='progress-bar-image'></div>";
        } else {
